      ...
      <div className="w-full max-w-md shadow-xl py-6 px-4 sm:px-6 md:px-8 bg-tertiary rounded-lg">
        <div className="flex justify-between">
          <p className="text-sm font-semibold">
            Welcome to <span className="text-primary/50">Abhyudaya Club</span>
          </p>
          <Link
            href="/"
        ...
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mt-2">
          Log In
        </h1>
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            ...
            <Link
              href="/forgot"
              className="text-xs text-primary hover:underline flex justify-end mt-1"
            >
              Forgot Password?
            </Link>
          </div>
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 sm:space-x-4 mt-6">
            <Link
              href="/signin"
              className="w-full sm:w-auto text-center text-sm font-medium border-2 border-primary py-2 px-4 rounded-md text-primary hover:bg-primary hover:text-white transition-colors duration-300"
            >
              Sign up
            </Link>
            <button
              type="submit"
              className="w-full sm:w-auto text-sm font-medium bg-primary py-2 px-4 rounded-md text-white hover:bg-primary/80 transition-colors duration-300"
            >
              Login
            </button>
          </div>
